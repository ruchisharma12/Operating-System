...
public class BoardModel {
	...
	private ArrayList<BoardController> listeners;
	...
	public BoardModel(int c, int r, int lc2, int bc2) {
		...
		listeners = new ArrayList<BoardController>();
	}
	...
	private void fireUpdate() {
		for (BoardController listener : listeners) {
	...
	public boolean isUndoable() {
		if (editcount >= 0 && editcount < 33 && undocount >= 0 && undocount < 32 && undocount < timesincelastundo
				&& undocount < (cyclecount * 33 + changecount) && 0 < (cyclecount * 33 + changecount)) {
			return true;
		}
		return false;
	}
	...
	public int edits() {
		return (cyclecount * 33 + changecount);
	}
